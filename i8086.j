...
*/
    ...
    i8086RegisterSS = 10,
    i8086RegisterES = 11,
    i8086ModRMModMask  = 196,
    i8086ModRMReg2Mask = 56,
    i8086ModRMReg1Mask = 7;
...
/* P */ case 062: [self execute_prefixDS]; break;
        ...
        case 128:   // Group 1 EbIb
                    var modrm = i8086ModRMMake([mem readByteAt:ip]); // The fetch of the byte will be done by the respective exec method
        ...
        //0xF
/* P */ case 240: [self execute_prefixLock]; break;
        case 241: [self invalidOpcodeException]; break;
/* P */ case 242: [self execute_prefixRepnz]; break;
/* P */ case 243: [self execute_prefixRepz]; break;
